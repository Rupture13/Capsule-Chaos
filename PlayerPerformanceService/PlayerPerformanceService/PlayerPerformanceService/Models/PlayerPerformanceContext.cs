...
namespace PlayerPerformanceService.Models
{
    public class PlayerPerformanceContext : DbContext
    {
        ...
        private void SeedContextOnStartup()
        {
            ...
            performance2.Snapshots.Add(snapshot1);
            performance2.Snapshots.Add(snapshot2);
            performance2.Snapshots.Add(snapshot3);
            performance2.Snapshots.Add(snapshot4);
            performance2.Snapshots.Add(snapshot5);
            performance2.Snapshots.Add(snapshot6);
            performance2.Snapshots.Add(snapshot7);
            performance2.Snapshots.Add(snapshot8);
            performance2.Snapshots.Add(snapshot9);
            performance2.Snapshots.Add(snapshot10);
            performance2.Snapshots.Add(snapshot11);
            performance2.Snapshots.Add(snapshot12);
            performance2.Snapshots.Add(snapshot13);
            performance2.Snapshots.Add(snapshot14);
            performance2.Snapshots.Add(snapshot15);
            performance2.Snapshots.Add(snapshot16);
            performance2.Snapshots.Add(snapshot17);
            performance2.Snapshots.Add(snapshot18);
            performance2.Snapshots.Add(snapshot19);
            performance2.Snapshots.Add(snapshot20);
            performance2.Snapshots.Add(snapshot21);
            performance2.Snapshots.Add(snapshot22);
            performance2.Snapshots.Add(snapshot23);
            performance2.Snapshots.Add(snapshot24);
            performance2.Snapshots.Add(snapshot25);
            performance2.Snapshots.Add(snapshot26);
            performance2.Snapshots.Add(snapshot27);
            performance2.Snapshots.Add(snapshot28);
            performance2.Snapshots.Add(snapshot29);
            performance2.Snapshots.Add(snapshot30);
            performance2.Snapshots.Add(snapshot31);
            performance2.Snapshots.Add(snapshot32);
            performance2.Snapshots.Add(snapshot33);
            performance2.Snapshots.Add(snapshot34);
            performance2.Snapshots.Add(snapshot35);
            performance2.Snapshots.Add(snapshot36);
            performance2.Snapshots.Add(snapshot37);
            performance2.Snapshots.Add(snapshot38);
            performance2.Snapshots.Add(snapshot39);
            performance2.Snapshots.Add(snapshot40);
            performance2.Snapshots.Add(snapshot41);
            performance2.Snapshots.Add(snapshot42);
            performance2.Snapshots.Add(snapshot43);
            performance2.Snapshots.Add(snapshot44);
            performance2.Snapshots.Add(snapshot45);
            performance2.Snapshots.Add(snapshot46);
            performance2.Snapshots.Add(snapshot47);
            performance2.Snapshots.Add(snapshot48);
            performance2.Snapshots.Add(snapshot49);
            performance2.Snapshots.Add(snapshot50);
            performance2.Snapshots.Add(snapshot51);
            performance2.Snapshots.Add(snapshot52);
            performance2.Snapshots.Add(snapshot53);
            performance2.Snapshots.Add(snapshot54);
            performance2.Snapshots.Add(snapshot55);
            performance2.Snapshots.Add(snapshot56);
